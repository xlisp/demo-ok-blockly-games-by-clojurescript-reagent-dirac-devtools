...
(defproject blockly-games-by-clojurescript-reagent "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "dev"
                ...
                ;; into your build
                :figwheel {:on-jsload "blockly-games-by-clojurescript-reagent.core/on-js-reload"
               ...
               {:id "min"
                :source-paths ["src"]
                :compiler {:output-to "resources/public/js/compiled/blockly_games_by_clojurescript_reagent.js"
                           :main blockly-games-by-clojurescript-reagent.core
